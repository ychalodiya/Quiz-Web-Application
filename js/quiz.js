(function(){
	...
	app.controller('QuizController',['$scope','$http','$sce',function($scope,$http,$sce){
		...
		$scope.createShareLinks = function(percentage){
			...
			var twitterLink = '<a class = "btn twitter" target="_blank" href="http://twitter.com/share?text= I scoread a '+percentage+'% on this quiz about Saturn. Try to beat my score at &amp;hashtags=SaturnQuiz&amp;url='+url+'">Tweet your score</a>';
